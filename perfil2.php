...
<html>
    ...
    <?php
        ...
        if($query->rowCount()){
            ...
            $u_SESSION["usuario"] = array($userr["nome"], $userr["email"], $userr["nivel"], $userr["cpf"], $userr["d_nasc"], $userr["tel"], $userr["profissao"],);
        ...
        <div id="mensagem"></div>
            ...
            <form id="formularioAtt2">
                <span class="titleend">endereço</span>
                    ...
                    <input type="text" name="bairroAtt" id="bairroAtt" />
                </div>

                <div id="linha">
                    <label for="cidAtt">Cidade</label>
                    <input type="text" name="cidAtt" id="cidAtt" />
                </div>

                <div id="linha">
                    <label for="endAtt">Endereço</label>
                    <input type="text" name="endAtt" id="endAtt" />
                </div>

                <div id="linha">
                    <label for="estadoAtt">Estado</label>
                    <input type="text" name="estadoAtt" id="estadoAtt" />
                </div>

                <div id="linha">
                    <label for="numAtt">Numero</label>
                    <input type="text" name="numAtt" id="numAtt" />
                </div>

                <div id="linha">
                    <label for="cepAtt">CEP</label>
                    <input type="text" name="cepAtt" id="cepAtt" />
                </div>

                <div id="linha">
                    <label for="complemAtt">Complemento</label>
                    <input type="text" name="complemAtt" id="complemAtt" />
                </div>
